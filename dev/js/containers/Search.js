...
class Search extends React.Component {
		...
		return (
			<div>
				...
				<div className="data-container col-lg-10 col-md-10 col-sm-12 col-xs-12">
					...
					<button className="sap-btn sap-btn-primary" onClick={this.requestSearch.bind(this)}>Search</button><br></br><br></br>
	...
	requestSearch() {
		...
		searchElement.company = this.refs.company.value;
		searchElement.revenue = this.refs.revenue.value;
		searchElement.TPDA = this.refs.TPDA.value;
		searchElement.location = this.refs.location.value;
		searchElement.custId = this.refs.custId.value;
